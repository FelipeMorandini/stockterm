...
All currently **OPEN** `roadmap`-labelled issues on `FelipeMorandini/stockterm`, verified 2026-05-30. Closed issues are intentionally omitted — see commit history / per-section `Shipped` lines for what has landed.

### Actionable

_None at this time — all roadmap-labelled issues are either shipped or deferred (see below)._

**Recently shipped:** [#214](https://github.com/FelipeMorandini/stockterm/issues/214) / **§74** — overlap inflight chain watchdog (sign-off **2026-05-30**). [#191](https://github.com/FelipeMorandini/stockterm/issues/191) / **§68** — Optional `CancellationToken` for superseded quote batches; default single-flight; opt-in overlap via `allow_overlapping_quote_batches` (sign-off **2026-05-30**; **PR:** [#215](https://github.com/FelipeMorandini/stockterm/pull/215)). [#204](https://github.com/FelipeMorandini/stockterm/issues/204) / **§73** — Config canonicalize persisted symbols on load (sign-off **2026-05-28**; **PR:** [#213](https://github.com/FelipeMorandini/stockterm/pull/213)). [#209](https://github.com/FelipeMorandini/stockterm/issues/209) / **§72** — Dashboard historical/news fetch gating on pane kinds (sign-off **2026-05-27**; **PR:** [#212](https://github.com/FelipeMorandini/stockterm/pull/212)). [#194](https://github.com/FelipeMorandini/stockterm/issues/194) / **§69** — saved/regex table filters + `saved_filters` in config (sign-off **2026-05-26**; **PR:** [#206](https://github.com/FelipeMorandini/stockterm/pull/206)). [#79](https://github.com/FelipeMorandini/stockterm/issues/79) / **§67** — Unicode `symbols_equivalent` + NFC `normalize_symbol` (sign-off **2026-05-25**; **PR:** [#205](https://github.com/FelipeMorandini/stockterm/pull/205)). [#192](https://github.com/FelipeMorandini/stockterm/issues/192) / **§66** — `Config::save` deprecation + `persist_config_*` helpers (code + manual QA sign-off **2026-05-25**). [#199](https://github.com/FelipeMorandini/stockterm/issues/199) / **§64**, [#200](https://github.com/FelipeMorandini/stockterm/issues/200) / **§65** — sign-off **2026-05-25**; **PR:** [#202](https://github.com/FelipeMorandini/stockterm/pull/202).
...
- **Shipped** — [#79](https://github.com/FelipeMorandini/stockterm/issues/79) Unicode ticker normalization — **§67** (sign-off **2026-05-25**; **PR:** [#205](https://github.com/FelipeMorandini/stockterm/pull/205)).
...
- **Shipped — [#194](https://github.com/FelipeMorandini/stockterm/issues/194) / [`docs/SPEC.md`](SPEC.md) §69** — Saved named filters + optional regex mode on Portfolio / Stock View (extends §23; **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#194** sign-off **2026-05-26**).

### 4.13 Technical — Async fetching, non-blocking UI

- **Implemented — §16 + optional cancel (Issues [#17](https://github.com/FelipeMorandini/stockterm/issues/17) / [#46](https://github.com/FelipeMorandini/stockterm/issues/46) / [#77](https://github.com/FelipeMorandini/stockterm/issues/77) / [#191](https://github.com/FelipeMorandini/stockterm/issues/191); [`docs/SPEC.md`](SPEC.md) §16.8, **§68**)**
  ...
  - **Shipped (§40 / 2026-05-19):** [#56](https://github.com/FelipeMorandini/stockterm/issues/56) explicit **`Semaphore::acquire`** handling in quote fan-out — see [`docs/SPEC.md`](SPEC.md) §40.2. **Shipped — [#191](https://github.com/FelipeMorandini/stockterm/issues/191) / §68 (2026-05-30):** optional **`CancellationToken`** when **`allow_overlapping_quote_batches`** is true; default remains single-flight + generation guard — **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#191** (sign-off **2026-05-30**; **PR:** [#215](https://github.com/FelipeMorandini/stockterm/pull/215)). **Shipped — [#214](https://github.com/FelipeMorandini/stockterm/issues/214) / §74 (2026-05-30):** overlap inflight chain watchdog — **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#214** (sign-off **2026-05-30**).
...
- **Shipped — [#24](https://github.com/FelipeMorandini/stockterm/issues/24) / [#208](https://github.com/FelipeMorandini/stockterm/issues/208) / [`docs/SPEC.md`](SPEC.md) §70–§71** — Custom dashboard tab (Phases A–D): all v1 read-only pane kinds, presets, in-app wizard editor; **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issues **#24**, **#208** (sign-off **2026-05-27**; **PR:** [#207](https://github.com/FelipeMorandini/stockterm/pull/207), [#210](https://github.com/FelipeMorandini/stockterm/pull/210), [#211](https://github.com/FelipeMorandini/stockterm/pull/211)).
...
3. **Shipped:** [#191](https://github.com/FelipeMorandini/stockterm/issues/191) **`CancellationToken`** — [`docs/SPEC.md`](SPEC.md) **§68** (sign-off **2026-05-30**; **PR:** [#215](https://github.com/FelipeMorandini/stockterm/pull/215)). **Shipped:** [#214](https://github.com/FelipeMorandini/stockterm/issues/214) overlap inflight chain watchdog — **§74** (sign-off **2026-05-30**).
...
5. **Shipped:** [#194](https://github.com/FelipeMorandini/stockterm/issues/194) saved/regex filters — **§69** (sign-off **2026-05-26**).
...
7. **M6 — Filters, customizable shortcuts, themes**
   - Substring filter over watchlist/portfolio — **done** (Issue [#16](https://github.com/FelipeMorandini/stockterm/issues/16) / §23, [PR #132](https://github.com/FelipeMorandini/stockterm/pull/132)); saved/regex filters — **done** ([#194](https://github.com/FelipeMorandini/stockterm/issues/194) / §69, sign-off **2026-05-26**).
