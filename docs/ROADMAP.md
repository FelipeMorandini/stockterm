...
- **Implemented — [#23](https://github.com/FelipeMorandini/stockterm/issues/23) / [`docs/SPEC.md`](SPEC.md) §43** — Cryptocurrency quotes (Yahoo `BTC-USD`, `SymbolKind`, adaptive price formatting, Stock View `-` entry, §43.13 Enter/quote keys) — **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#23** (sign-off **2026-05-19**; **PR:** TBD). Follow-ups: [#157](https://github.com/FelipeMorandini/stockterm/issues/157) (provider symbol resolver), [#158](https://github.com/FelipeMorandini/stockterm/issues/158) (Kind from API metadata).
- **Missing** — Technical indicators (SMA/EMA/RSI/MACD), options chains,
  custom widgets, backtesting. No code beyond the §43 plan.
...
9. **M8 — Optional / advanced**
   ...
   - Indicators (SMA/EMA/RSI/MACD), options, backtesting, custom widgets.
