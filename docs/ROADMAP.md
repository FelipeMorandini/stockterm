...
- **Planned — [#176](https://github.com/FelipeMorandini/stockterm/issues/176) / [#177](https://github.com/FelipeMorandini/stockterm/issues/177) / [`docs/SPEC.md`](SPEC.md) §53** — §52 follow-ups: Polygon historical `next_url` pagination (`POLYGON_HISTORICAL_MAX_PAGES`) + Options zero-clone draw via `TableState` / `render_stateful_widget`.
