...
- **Shipped — [#65](https://github.com/FelipeMorandini/stockterm/issues/65) / [`docs/SPEC.md`](SPEC.md) §52.1** — Polygon aggregates `limit` cap, partial-page notice on Charts (provider-gated), plan-tier error copy — **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#65** (sign-off **2026-05-22**; **PR:** TBD).
