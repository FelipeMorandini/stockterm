...
**Triage policy:** [#24](https://github.com/FelipeMorandini/stockterm/issues/24), [#68](https://github.com/FelipeMorandini/stockterm/issues/68), [#191](https://github.com/FelipeMorandini/stockterm/issues/191) are intentionally deferred/low priority and should not be auto-closed during backlog sweeps.
...
- **Shipped (Phase A) — [#24](https://github.com/FelipeMorandini/stockterm/issues/24) / [`docs/SPEC.md`](SPEC.md) §70** — Custom dashboard tab, config-driven grid, read-only watchlist panes (`dual_watchlist`); **manual QA** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#24** (sign-off pending; **PR:** [#207](https://github.com/FelipeMorandini/stockterm/pull/207)). Phases B–D (chart/news/portfolio panes, in-app editor) remain deferred.
