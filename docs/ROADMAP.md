...
- **Partial — further polish** — dense candle layout vs web charts; optional follow-ups [#78](https://github.com/FelipeMorandini/stockterm/issues/78)–[#79](https://github.com/FelipeMorandini/stockterm/issues/79) (recovery hardening, Unicode tickers).
