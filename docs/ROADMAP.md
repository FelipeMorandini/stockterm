...
- **Implemented (Issues [#81](https://github.com/FelipeMorandini/stockterm/issues/81) / [#82](https://github.com/FelipeMorandini/stockterm/issues/82) / [#83](https://github.com/FelipeMorandini/stockterm/issues/83), `docs/SPEC.md` §36)** — narrow-terminal Stock View two-line status; plain-**Tab**/**BackTab** portfolio/alert dialog focus (`tab_key_plain`); **`add_to_portfolio`** false-path rustdoc + **`PORTFOLIO_ADD_INVALID_SYMBOL_INLINE`**; manual QA [`docs/QA_PLAN.md`](QA_PLAN.md) Issues **#81–#83** (sign-off **2026-05-18**; **PR:** [#151](https://github.com/FelipeMorandini/stockterm/pull/151)).
- **Partial — further polish** — optional decimal money ([#68](https://github.com/FelipeMorandini/stockterm/issues/68)); row edit UI not implemented.
