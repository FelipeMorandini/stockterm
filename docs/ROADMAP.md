...
- **Shipped (pending QA) — [#176](https://github.com/FelipeMorandini/stockterm/issues/176) / [#177](https://github.com/FelipeMorandini/stockterm/issues/177) / [`docs/SPEC.md`](SPEC.md) §53** — Polygon historical `next_url` pagination + Options zero-clone draw — **PR:** [#179](https://github.com/FelipeMorandini/stockterm/pull/179); manual QA [`docs/QA_PLAN.md`](QA_PLAN.md) Issues **#176, #177**.
