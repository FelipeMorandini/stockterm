...
- **Implemented (Issues #11 / #29)** — list, scroll, Enter → open URL (sync).
  ...
  - **Shipped — `query2` drift (#54):** [`yahoo_news_query2_from_text`](../src/api/yahoo.rs) lenient paths + **`STOCKTERM_DEBUG_YAHOO_NEWS`** — **§36** / [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#54** (sign-off **2026-05-18**).
