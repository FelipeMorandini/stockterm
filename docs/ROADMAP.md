...
- **Missing** — Options chains, custom widgets, backtesting (no SPEC slice yet).
...
9. **M8 — Optional / advanced**
   ...
   - Options, backtesting, custom widgets remain future.
