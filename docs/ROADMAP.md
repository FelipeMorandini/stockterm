...
| [#24](https://github.com/FelipeMorandini/stockterm/issues/24)  | Advanced: custom widgets — post-MVP | Deferred until widget need outgrows ratatui built-ins — **§70** (SPEC + QA planned 2026-05-26). |
...
- **Deferred — [#24](https://github.com/FelipeMorandini/stockterm/issues/24)** — Custom dashboard panes / composable widgets (post-MVP) — [`docs/SPEC.md`](SPEC.md) **§70**; manual QA [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#24** after product trigger.
