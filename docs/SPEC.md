...
**Status:** **Shipped** (2026-05-30) — **`tokio-util`** cancellation, **`allow_overlapping_quote_batches`** (default **`false`**), stale-generation tests; manual QA [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#191** pending sign-off.
