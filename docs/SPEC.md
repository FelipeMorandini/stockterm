...
**Status:** **Phase A shipped** (2026-05-26) — `Tab::Dashboard`, config-driven grid, read-only **watchlist** panes, `dual_watchlist` fixture. Phases B–D (additional pane kinds, in-app editor) remain future work. **Manual QA:** [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#24**.
