...
- **Status:** Shipped — manual QA [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#199** — sign-off **2026-05-25** (with **#200** in same change set).
...
- **Status:** Shipped — manual QA [`docs/QA_PLAN.md`](QA_PLAN.md) Issue **#200** — sign-off **2026-05-25** (with **#199** in same change set).
