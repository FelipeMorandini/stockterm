...
| `saved_filters` | array | `[]` | Named table filters for Stock View / Portfolio (Issue #194 / §69). Each entry: `{ "name", "pattern", "regex" }`. |
